...
The empirical distribution for some selected features are shown in figure (\ref{fig:features}), from which we choose proper family of distribution for our HMM model. 
